...
{
    if (page == OPENVELA_UI_SPORT_PAGE_CALORIES) {
        return chinese ? "\345\215\203\345\215\241" : "KCAL";
    }
    if (page == OPENVELA_UI_SPORT_PAGE_DURATION) {
        return chinese ? "\345\210\206\351\222\237" : "MIN";
    }
    return chinese ? "\346\255\245" : "STEPS";
}
...
{
    if (page == OPENVELA_UI_SPORT_PAGE_CALORIES) {
        return chinese ? "\345\215\241\350\267\257\351\207\214" : "CALORIES";
    }
    if (page == OPENVELA_UI_SPORT_PAGE_DURATION) {
        return chinese ? "\350\277\220\345\212\250\346\227\266\351\225\277" : "DURATION";
    }
    return chinese ? "\346\255\245\346\225\260" : "STEPS";
}
...
static void sport_date_label(int days_before, char *buffer, size_t size)
{
    ...
    snprintf(buffer, size, "%02d\346\234\210%02d\346\227\245", local.tm_mon + 1,
             local.tm_mday);
}
                                ...
                                int32_t width, lv_obj_t **image_out)
{
    ...
    *image_out = NULL;
    return sport_make_icon_fallback(sport, parent, x + width / 8, y,
                                    width * 3 / 4,
                                    sport_has_chinese(sport) ? "\345\226\265" : "CAT",
                                    0xd9b68f);
}
...
static void sport_create_entry_page(openvela_ui_sport_t *sport)
{
    ...
    sport_label(sport, sport->entry_page,
                sport_has_chinese(sport) ? "\350\277\220\345\212\250\346\250\241\345\274\217" : "SPORT MODE",
    ...
    if (!jump) {
        sport_make_icon_fallback(sport, sport->entry_page,
                                 152, 112, 128,
                                 sport_has_chinese(sport) ? "\350\267\263" : "GO",
                                 0x6559ef);
    }
    ...
    sport->enter_button_label = sport_label(sport, sport->enter_button,
        sport_has_chinese(sport) ? "\350\277\233\345\205\245\350\277\220\345\212\250" : "START",
...
static void sport_create_stats_page(openvela_ui_sport_t *sport)
{
    ...
    sport->chart_heading = sport_label(
        sport, card, sport_has_chinese(sport) ? "\344\273\212\346\227\245\350\266\213\345\212\277" : "TODAY",
        sport->fonts.body, 0x142a65,
    ...
    sport_label(sport, card,
                sport_has_chinese(sport) ?
                    "\345\267\246\345\217\263\346\273\221\345\212\250\346\237\245\347\234\213\345\205\250\345\244\251" : "SWIPE FOR 24 HOURS",
    ...
    sport_label(sport, sport->stats_page,
                sport_has_chinese(sport) ?
                    "\345\267\246\346\273\221\345\216\206\345\217\262 \302\267 \344\270\212\344\270\213\345\210\207\346\215\242\346\214\207\346\240\207" :
                    "LEFT: HISTORY \302\267 UP/DOWN: METRIC",
...
static void sport_create_history_page(openvela_ui_sport_t *sport)
{
    ...
    sport_label(sport, sport->history_page,
                sport_has_chinese(sport) ?
                    "\345\267\246\346\273\221\346\237\245\347\234\213\347\233\256\346\240\207 \302\267 \345\217\263\346\273\221\350\277\224\345\233\236" :
                    "LEFT: GOAL \302\267 RIGHT: BACK",
                sport->fonts.small, 0xe2e8f6,
...
static void sport_create_goal_page(openvela_ui_sport_t *sport)
{
    ...
    card = sport_box(sport, sport->goal_page, 24, 76, 384, 326,
                     0xffffff, 30, (lv_opa_t)244);
    sport_label(sport, card,
                sport_has_chinese(sport) ? "\344\273\212\346\227\245\347\233\256\346\240\207" : "TODAY GOAL",
                sport->fonts.body, 0x142a65,
    ...
    sport_label(sport, sport->goal_page,
                sport_has_chinese(sport) ?
                    "\345\217\263\346\273\221\350\277\224\345\233\236\345\216\206\345\217\262" : "SWIPE RIGHT TO HISTORY",
                sport->fonts.small, 0xe2e8f6,
...
static void sport_create_goal_editor_page(openvela_ui_sport_t *sport)
{
    ...
    sport_label(sport, sport->goal_editor_page,
                sport_has_chinese(sport) ? "\344\277\256\346\224\271\347\233\256\346\240\207" : "EDIT GOAL",
                sport->fonts.body, 0xffffff,
    ...
    sport_label(sport, card,
                sport_has_chinese(sport) ? "\347\233\256\346\240\207\346\225\260\345\200\274" : "TARGET",
    ...
    sport_create_goal_key(sport, card, 30, 306, 10,
                          sport_has_chinese(sport) ? "\346\270\205\347\251\272" : "CLR");
    sport_create_goal_key(sport, card, 146, 306, 0, "0");
    sport_create_goal_key(sport, card, 262, 306, 11,
                          sport_has_chinese(sport) ? "\345\210\240\351\231\244" : "DEL");
    ...
    sport_label(sport, confirm,
                sport_has_chinese(sport) ? "\347\241\256\350\256\244\344\277\256\346\224\271" : "SAVE GOAL",
                sport->fonts.body, 0xffffff,
...
static void sport_create_celebration_layer(openvela_ui_sport_t *sport)
{
    ...
    sport_label(sport, card,
                sport_has_chinese(sport) ? "\346\201\255\345\226\234\357\274\201" : "CONGRATULATIONS!",
                sport->fonts.title, 0xffd24d,
                24, 26, 308, LV_TEXT_ALIGN_CENTER);
    sport_label(sport, card,
                sport_has_chinese(sport) ?
                    "\344\273\212\345\244\251\346\211\200\346\234\211\350\277\220\345\212\250\347\233\256\346\240\207" : "ALL SPORT GOALS",
                sport->fonts.body, 0xffffff,
                24, 101, 308, LV_TEXT_ALIGN_CENTER);
    sport_label(sport, card,
                sport_has_chinese(sport) ?
                    "\345\267\262\347\273\217\345\256\214\346\210\220\357\274\201" : "COMPLETED!",
                sport->fonts.body, 0xffffff,
                24, 151, 308, LV_TEXT_ALIGN_CENTER);
    sport_label(sport, sport->celebration_layer,
                sport_has_chinese(sport) ?
                    "\347\202\271\345\207\273\345\261\217\345\271\225\347\273\247\347\273\255" : "TAP TO CONTINUE",
...
static void sport_create_heart_page(openvela_ui_sport_t *sport)
{
    ...
    sport_label(sport, sport->heart_page,
                sport_has_chinese(sport) ? "\346\214\201\347\273\255\345\277\203\347\216\207" : "HEART RATE",
                sport->fonts.title, 0xffffff,
    ...
    if (sport->heart_image) {
        ...
        sport->heart_visual = sport_make_icon_fallback(
            sport, sport->heart_page, 114, 86, 205, "\342\231\245", 0xff232b);
    }

    sport_label(sport, sport->heart_page,
                sport_has_chinese(sport) ?
                    "\350\277\220\345\212\250\346\250\241\345\274\217 \302\267 \351\225\277\346\227\266\351\227\264\347\233\221\346\265\213\344\270\255" : "WORKOUT MONITORING",
    ...
    sport->heart_threshold = sport_label(sport, sport->heart_page,
        sport_has_chinese(sport) ?
            "\350\266\205\350\277\207 160 BPM \345\260\206\350\207\252\345\212\250\346\217\220\351\206\222" : "ALERT ABOVE 160 BPM",
...
static void sport_create_exit_page(openvela_ui_sport_t *sport)
{
    ...
    sport_label(sport, sport->exit_page,
                sport_has_chinese(sport) ?
                    "\351\200\200\345\207\272\350\277\220\345\212\250\346\250\241\345\274\217" : "END WORKOUT",
                sport->fonts.body, 0xffffff,
    ...
    sport_label(sport, sport->exit_page,
                sport_has_chinese(sport) ?
                    "\346\234\254\346\254\241\350\277\220\345\212\250\346\225\260\346\215\256\345\267\262\345\256\236\346\227\266\344\277\235\345\255\230" : "WORKOUT DATA SAVED",
...
static void sport_create_confirm_layer(openvela_ui_sport_t *sport)
{
    ...
    sport_label(sport, card,
                sport_has_chinese(sport) ?
                    "\347\273\223\346\235\237\346\234\254\346\254\241\350\277\220\345\212\250\357\274\237" : "END WORKOUT?",
                sport->fonts.body, 0xffffff,
                20, 28, 314, LV_TEXT_ALIGN_CENTER);
    sport_label(sport, card,
                sport_has_chinese(sport) ?
                    "\350\277\220\345\212\250\346\225\260\346\215\256\345\267\262\347\273\217\344\277\235\345\255\230" : "YOUR DATA IS SAVED",
    ...
    sport_label(sport, cancel,
                sport_has_chinese(sport) ? "\345\217\226\346\266\210" : "CANCEL",
                sport->fonts.body, 0xffffff,
    ...
    sport_label(sport, confirm,
                sport_has_chinese(sport) ? "\347\241\256\350\256\244\347\273\223\346\235\237" : "END",
                sport->fonts.body, 0xffffff,
                8, 13, 128, LV_TEXT_ALIGN_CENTER);
...
static void sport_format_compact(char *buffer, size_t size, uint32_t value)
{
    ...
    snprintf(buffer, size, "%lu.%lu\344\270\207",
...
static void sport_update_stats(openvela_ui_sport_t *sport)
{
    ...
    if (sport->page == OPENVELA_UI_SPORT_PAGE_CALORIES) {
        title = sport_has_chinese(sport) ? "\345\215\241\350\267\257\351\207\214\347\273\237\350\256\241" : "CALORIES";
        current = sport_has_chinese(sport) ? "\345\275\223\345\211\215\345\215\241\350\267\257\351\207\214" : "CURRENT";
        unit = sport_has_chinese(sport) ? "\345\215\203\345\215\241" : "KCAL";
    } else if (sport->page == OPENVELA_UI_SPORT_PAGE_DURATION) {
        title = sport_has_chinese(sport) ? "\350\277\220\345\212\250\346\227\266\351\225\277\347\273\237\350\256\241" : "DURATION";
        current = sport_has_chinese(sport) ? "\345\275\223\345\211\215\350\277\220\345\212\250\346\227\266\351\225\277" : "CURRENT";
        unit = sport_has_chinese(sport) ? "\345\210\206\351\222\237" : "MIN";
    } else {
        title = sport_has_chinese(sport) ? "\346\255\245\346\225\260\347\273\237\350\256\241" : "STEPS";
        current = sport_has_chinese(sport) ? "\345\275\223\345\211\215\346\255\245\346\225\260" : "CURRENT";
        unit = sport_has_chinese(sport) ? "\346\255\245" : "STEPS";
    }

    lv_label_set_text(sport->stats_title, title);
    lv_label_set_text(sport->chart_heading,
                      sport_has_chinese(sport) ? "\344\273\212\346\227\245\350\266\213\345\212\277" : "TODAY");
...
static void sport_update_history(openvela_ui_sport_t *sport)
{
    ...
    snprintf(title, sizeof(title), "%s%s",
             ...
             sport_has_chinese(sport) ? "\345\216\206\345\217\262" : " HISTORY");
...
static void sport_update_history_detail(openvela_ui_sport_t *sport)
{
    ...
    snprintf(goal_text, sizeof(goal_text),
             sport_has_chinese(sport) ? "\347\233\256\346\240\207\357\274\232%s%s" : "GOAL: %s %s",
             goal_value,
             sport_metric_unit(sport->page, sport_has_chinese(sport)));
    snprintf(current_text, sizeof(current_text),
             sport_has_chinese(sport) ? "\345\275\223\346\227\245%s" : "DAY %s",
             sport_metric_name(sport->page, sport_has_chinese(sport)));

    lv_label_set_text(sport->stats_title, date);
    lv_label_set_text(sport->chart_heading,
                      sport_has_chinese(sport) ? "\345\275\223\346\227\245\350\266\213\345\212\277" : "DAY TREND");
...
static void sport_update_goal(openvela_ui_sport_t *sport)
{
    ...
    if (sport_has_chinese(sport)) {
        if (sport->page == OPENVELA_UI_SPORT_PAGE_STEPS) {
            snprintf(edit_text, sizeof(edit_text), "\344\277\256\346\224\271\347\233\256\346\240\207\346\255\245\346\225\260");
        } else {
            snprintf(edit_text, sizeof(edit_text), "\344\277\256\346\224\271%s\347\233\256\346\240\207",
...
static void sport_update_goal_editor(openvela_ui_sport_t *sport)
{
    ...
    snprintf(hint, sizeof(hint),
             sport_has_chinese(sport) ? "\350\257\267\350\276\223\345\205\245 %lu\357\275\236%lu" :
                                        "ENTER %lu - %lu",
...
static void sport_goal_confirm_clicked(lv_event_t *event)
{
    ...
    if (sport->goal_input < sport_goal_minimum(metric) ||
        ...
        snprintf(hint, sizeof(hint),
                 sport_has_chinese(sport) ? "\347\233\256\346\240\207\351\234\200\345\234\250 %lu\357\275\236%lu \344\271\213\351\227\264" :
                                            "GOAL MUST BE %lu - %lu",
                 (unsigned long)sport_goal_minimum(metric),
                 (unsigned long)sport_goal_maximum(metric));
        lv_label_set_text(sport->goal_input_hint, hint);
...
static void sport_cancel_enter_feedback(openvela_ui_sport_t *sport)
{
    ...
    if (sport->enter_button_label &&
        ...
        lv_label_set_text(sport->enter_button_label,
                          sport_has_chinese(sport) ?
                              "\350\277\233\345\205\245\350\277\220\345\212\250" : "START");
    }
...
static void sport_enter_clicked(lv_event_t *event)
{
    ...
    lv_label_set_text(sport->enter_button_label,
                      sport_has_chinese(sport) ? "\346\255\243\345\234\250\350\277\233\345\205\245" : "STARTING");
